...
import { MsgAggregateExchangeRatePrevote as MsgAggregateExchangeRatePrevote_pb } from '@web4/iq.proto/iq/oracle/v1beta1/tx';
...
> {
  ...
  public packAny(): Any {
    return Any.fromPartial({
      typeUrl: '/iq.oracle.v1beta1.MsgAggregateExchangeRatePrevote',
